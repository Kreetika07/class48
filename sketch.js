...
var coinCount = 0;
var vaccineCount = 0;
var coin, coinImg,coinImg2, coinGrp;
...
function preload() {
  ...
  coinImg2 = loadAnimation("images/coins/coin1.png", "images/coins/coin2.png", "images/coins/coin3.png", "images/coins/coin4.png", "images/coins/coin5.png");
  ...
  if (gameState === "play") {
    ...
    if (vaccineCount >= 4 && humanHealth < 5) {
      if (keyDown("R")) {
        ...
        if (humanHealth === 5) {
          text("Health Is Full", height - 500, width / 3);
        }
      }
